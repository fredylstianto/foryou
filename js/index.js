...
var S = {
  init: function () {
    ...
    if (i !== -1) {
      ...
      S.UI.simulate("|#countdown 3||Hello|Sheikaa|My|Love?||#rectangle|");
    }
...
S.Dot = function (x, y) {
  // Hanya memperkecil titik jika di HP agar pas ukurannya
  var dotSize = window.innerWidth < 600 ? 2.5 : 5;
...
S.ShapeBuilder = (function () {
  ...
  function fit() {
    // Memperkecil gap antar titik di HP supaya tulisan tetap solid (tidak renggang)
    gap = window.innerWidth < 600 ? 6 : 13;
  ...
  return {
    ...
    rectangle: function (w, h) {
      ...
      */
      ...
      // Pengaman agar script ini mengembalikan objek kosong dan tidak crash
      return { dots: [], w: 0, h: 0 };
    }
  };
}());
...
S.Shape = (function () {
  ...
  return {
    ...
    switchShape: function (n, fast) {
      ...
      // Target ukuran dot secara responsif (sama dengan deklarasi di S.Dot)
      var targetDotSize = window.innerWidth < 600 ? 2.5 : 5;
